...
('978-4-75-750966-5', 'Fullmetal Alchemist VOL.5 (Special!)', 'Hiromu Arakawa', 'full_metal.jpg', 'A hardcover, deluxe collector’s edition of one of the most beloved manga and anime of all time! Fully remastered with an updated translation and completely fresh lettering, and presented with color pages on large-trim archival-quality paper, this gorgeous hardcover edition presents the timeless dark adventures of the Elric brothers as they were truly meant to be seen.\r\n\r\n Includes brand-new cover art, with color insert and behind-the-scenes character sketches from author Hiromu Arakawa!', '741.00', 1);
